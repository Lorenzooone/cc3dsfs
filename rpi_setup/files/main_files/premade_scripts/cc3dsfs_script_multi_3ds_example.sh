...
# Middle-Right
${MAIN_KIOSK_PROGRAM} ${EXTRA_COMMANDS} --enabled_both 1 --pos_x_both 800 --pos_y_both 0 --profile 5 --auto_connect &
sleep ${SLEEP_TIME}

# Middle-Left
${MAIN_KIOSK_PROGRAM} ${EXTRA_COMMANDS} --enabled_both 1 --pos_x_both 400 --pos_y_both 0 --profile 5 --auto_connect &
sleep ${SLEEP_TIME}

fi

# Leftmost
${MAIN_KIOSK_PROGRAM} ${EXTRA_COMMANDS} --enabled_both 1 --pos_x_both 0 --pos_y_both 0 --profile 5 --auto_connect
